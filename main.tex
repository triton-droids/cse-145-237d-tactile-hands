...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.62\linewidth]{figures/control_loop.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\linewidth]{figures/mvp_hand.png}
...
\includegraphics[width=\linewidth]{figures/calib_rig.png}
\end{minipage}\hfill
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.42\linewidth]{figures/closed_hand.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.45\linewidth]{figures/sim_inhand.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\linewidth]{figures/vr_index_hand.png}\hfill
\includegraphics[width=0.46\linewidth]{figures/vr-demo.png}
\caption{VR teleoperation. Left: the Valve Index controller's native capacitive
finger tracking is streamed over ROS~2 and mapped onto the robotic hand's
fingers, driving finger curl directly from the operator's hand. Right: the
controller's 6-DoF pose drives the ARCTOS arm end-effector through our
end-to-end framework (frame calibration, IK, and motion smoothing), giving
VR-driven control of the arm-mounted hand that we continue to refine.}
\label{fig:vrindex}
\end{figure}
...
to physical arm motion is closed (Figure~\ref{fig:vrindex}, right). The framework is not
...
feedback disabled so the fingers simply close to a fixed curl. In each run the
operator drives the same Index controller to the same cup, and only the state of
the force loop differs.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.58\linewidth]{figures/yolo_detection.png}
